...
const Calendar = ({ month, year }) => {
  return (
    <div className="bg-black w-full h-full rounded-4xl p-4 ">
      <div className=" text-white font-ligh rounded-2xl  text-center grid grid-cols-7 grid-rows-7  border overflow-auto">
        {daysList.map((d, idx) => (
          <div
            key={idx}
            style={{ gridColumnStart: idx + 1 }}
            className={`font-bold w-full items-center flex justify-center table-border`}>
